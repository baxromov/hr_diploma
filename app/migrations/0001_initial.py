    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_work', models.TimeField(default=datetime.time(9, 0), verbose_name='Ish boshlanishi')),
                ('lunch_start', models.TimeField(default=datetime.time(13, 0), verbose_name='Tushlik vaqti')),
                ('lunch_end', models.TimeField(default=datetime.time(14, 0), verbose_name='Tushlik tugash vaqti')),
                ('end_work', models.TimeField(default=datetime.time(18, 0), verbose_name='Ish Tugash vaqti')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
